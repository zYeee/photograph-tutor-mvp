...
2. what are you build and why?  
   * A real-time voice AI photography tutor. The core idea is that learning photography is hard to do from text, you need someone to talk through concepts with you, adapt to your level, and give you feedback in the moment. This app puts an AI tutor in your ear: you speak, it listens, teaches structured lessons or gives on-location scene advice, and tracks what you've covered across sessions.
